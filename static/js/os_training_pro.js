...
function unlockAudio() {
    ...
    soundPlayer.src = '/static/sounds/os_pro/os_pro_task1.mp3';
...
function playSound(soundName) {
    ...
    soundPlayer.src = `/static/sounds/os_pro/${soundName}`;
    soundPlayer.currentTime = 0;
...
window.toggleHelp = function(taskNum) {
    ...
    if (soundEnabled) {
        if (taskNum == 1) {
            ...
            playSound('os_pro_task2_help.mp3');
        } else if (taskNum == 3) {
            playSound('os_pro_task3_help.mp3');
        } else if (taskNum == 4) {
            playSound('os_pro_task4_help.mp3');
        }
    }
};
