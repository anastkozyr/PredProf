// five_training_basic.js - ОЗВУЧКА с кнопкой управления для базовой Пятерочки
...
function unlockAudio() {
    ...
    soundPlayer.src = '/static/sounds/five_basic/five_task1.mp3';
...
function playSound(soundName) {
    ...
    soundPlayer.src = `/static/sounds/five_basic/${soundName}`;
    soundPlayer.currentTime = 0;
...
window.toggleHelp = function(taskNum) {
    ...
    if (soundEnabled) {
        if (taskNum == 1) {
            playSound('five_task1_help.mp3');
        } else if (taskNum == 2) {
            playSound('five_task2_help.mp3');
        } else if (taskNum == 3) {
            playSound('five_task3_help.mp3');
        } else if (taskNum == 4) {
            playSound('five_task4_help.mp3');
        }
    }
};
